    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Color", "Icon", "IsActive", "Name", "Slug", "SortOrder" },
                values: new object[,]
                {
                    { 1, "#6B7280", "bi-house-door", true, "Стена", "wall", 1 },
                    { 2, "#F59E0B", "bi-bag", true, "Барахолка", "market", 2 },
                    { 3, "#10B981", "bi-heart", true, "Взаимовыручка", "aid", 3 },
                    { 4, "#8B5CF6", "bi-bar-chart-line", true, "Голосования", "poll", 4 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "Id", "Color", "Description", "Icon", "IsActive", "Name", "SortOrder" },
                values: new object[,]
                {
                    { 1, "#3B82F6", "Вызов сантехника", "bi-droplet", true, "Сантехника", 1 },
                    { 2, "#F59E0B", "Вызов электрика", "bi-lightning-charge", true, "Электрика", 2 },
                    { 3, "#10B981", "Уборка территории", "bi-stars", true, "Уборка", 3 },
                    { 4, "#8B5CF6", "Вопросы безопасности", "bi-shield-check", true, "Охрана", 4 },
                    { 5, "#6B7280", "Прочие обращения", "bi-three-dots", true, "Другое", 5 }
                });
